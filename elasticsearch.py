...
STATS_ES1 = {
    ...
    'health.number_of_data_nodes': Stat("gauge", "nodes.%s.health.number_of_data_nodes"),
    'health.active_shards': Stat("gauge", "nodes.%s.health.active_shards"),
    'health.initializing_shards': Stat("gauge", "nodes.%s.health.initializing_shards"),
    'health.unassigned_shards': Stat("gauge", "nodes.%s.health.unassigned_shards"),
    'health.delayed_unassigned_shards': Stat("gauge", "nodes.%s.health.delayed_unassigned_shards"),
    'health.relocating_shards': Stat("gauge", "nodes.%s.health.relocating_shards"),
